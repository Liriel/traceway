    ...
    <main className="relative">
      <section className="wrap py-20">
        <article className="prose">
          ...
          <h1 className="mt-4 mb-3">Terms of Use</h1>
          ...
          <p>
            ...
            these terms, you may not use the Service. These terms apply to the
            Traceway Cloud offering operated by Traceway (&ldquo;we&rdquo;,
          ...
          <p>
            ...
            distributed tracing, metrics, logs, and Impact Score prioritization.
            The Service ingests telemetry data from your applications via the
            Traceway SDK or OpenTelemetry and presents it through a web
            dashboard.
          </p>
          ...
          <h2>5. Open-Source License Disclaimer</h2>
          <p>
            Traceway is available as open-source software for self-hosting. The
            self-hosted version is provided &ldquo;as is&rdquo; without warranty
            of any kind, express or implied, including but not limited to the
            warranties of merchantability, fitness for a particular purpose,
            and non-infringement. Traceway takes no responsibility for any
            issues, data loss, security vulnerabilities, or downtime arising
            from customer self-hosted deployments. You are solely responsible
            for the operation, maintenance, and security of your self-hosted
            instance.
          </p>

          <h2>6. Intellectual Property</h2>
          <p>
            The Traceway name, logo, and branding are the property of Traceway.
            The Traceway Cloud platform design, proprietary infrastructure, and
            service delivery are owned by us. The open-source codebase is
          ...
          <p>
            ...
            this page with a revised &ldquo;Last updated&rdquo; date. Continued
